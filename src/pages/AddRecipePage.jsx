        ...
        <div className="max-w-3xl mx-auto bg-white/80 dark:bg-dark-surface/95 rounded-2xl shadow-xl border border-light-border/60 dark:border-dark-muted/80 backdrop-blur-sm p-6 sm:p-8">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm md:text-base text-light-text dark:text-dark-muted">
              Add your own dish with ingredients and step-by-step instructions. You&apos;ll use this every time you cook it.
            </p>
          </div>
          ...
          <form onSubmit={submitForm} className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {/* Meal Type */}
              <div>
                <label htmlFor="type" className="block text-xs font-semibold uppercase tracking-wide text-light-text dark:text-dark-muted mb-2">
                  Meal type
                </label>
                <select
                  id="type"
              ...
              {/* Time */}
              <div>
                <label htmlFor="time" className="block text-xs font-semibold uppercase tracking-wide text-light-text dark:text-dark-muted mb-2">
                  Time to make
                </label>
                <select
                  id="time"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              <div className="md:col-span-2">
                <label htmlFor="title" className="block text-xs font-semibold uppercase tracking-wide text-light-text dark:text-dark-muted mb-2">
                  Recipe name
                </label>
                <input
                  type="text"
                  ...
                  name="title"
                  className="w-full rounded-xl border border-light-border/80 dark:border-dark-muted/80 bg-white dark:bg-dark-bg/60 dark:text-dark-text px-3 py-2.5 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-light-accent/60 dark:focus:ring-dark-accent/70"
                  placeholder="e.g. One-pot chicken noodle soup"
                  required
                  value={title}
              ...
              <div>
                <label htmlFor="imgUrl" className="block text-xs font-semibold uppercase tracking-wide text-light-text dark:text-dark-muted mb-2">
            ...
            <div className="border-t border-light-border/60 dark:border-dark-muted/60 pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  <label htmlFor="creator_name" className="block text-xs font-semibold uppercase tracking-wide text-light-text dark:text-dark-muted mb-2">
                    Creator name
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="description" className="block text-xs font-semibold uppercase tracking-wide text-light-text dark:text-dark-muted mb-2">
                    Short description
                  </label>
                  <textarea
                    id="description"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                <label htmlFor="ingredients" className="block text-xs font-semibold uppercase tracking-wide text-light-text dark:text-dark-muted mb-2">
                  Ingredients
                </label>
                <textarea
                  id="ingredients"
              ...
              <div>
                <label htmlFor="instructions" className="block text-xs font-semibold uppercase tracking-wide text-light-text dark:text-dark-muted mb-2">
                  Instructions
                </label>
                <textarea
                  id="instructions"
